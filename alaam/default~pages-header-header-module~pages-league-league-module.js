(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-header-header-module~pages-league-league-module"],{
...
var HeaderService = /** @class */ (function () {
    function HeaderService(http, router, route) {
        this.http = http;
        this.router = router;
        this.route = route;
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'application/json');
    }
    HeaderService.prototype.getAll = function () {
        return this.http.get(apiUrl + 'header/list');
    };
    HeaderService.prototype.getCategory = function () {
    ...
    // Create header
    HeaderService.prototype.addHeader_old = function (header) {
        //console.log(header);
        ...
        return this.http.post(apiUrl + 'header/add', formData, {
            reportProgress: true,
            observe: 'events'
        });
    };
    HeaderService.prototype.addHeader = function (header) {
        console.log('service');
        console.log(header);
        return this.http.post(apiUrl + 'header/add', header);
    };
    HeaderService.prototype.getById = function (id) {
        return this.http.get(apiUrl + 'header/get_by_id/' + id);
    };
    HeaderService.prototype.getByIdCategories = function (id) {
        return this.http.get(apiUrl + 'header/categories/' + id);
    };
    HeaderService.prototype.update_old = function (header, id) {
        var formData = new FormData();
        formData.append("title", header.title);
        formData.append("icon", header.icon);
        formData.append("description", header.description);
    ...
    HeaderService.prototype.update = function (header, id) {
        return this.http.patch(apiUrl + 'header/update/' + id, header);
    };
    HeaderService.prototype.updateStatus = function (header) {
        return this.http.patch(apiUrl + 'header/update_status', header);
    };
    HeaderService.prototype.delete = function (id) {
        return this.http.delete(apiUrl + 'header/del/' + id);
    };
    HeaderService.prototype.checkCategory = function (params) {
        return this.http.get(apiUrl + 'header/check_category', { params: params });
    };
...
//# sourceMappingURL=default~pages-header-header-module~pages-league-league-module.js.map